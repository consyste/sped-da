...
//                    $contador++;
    ...
    protected function zModalAquaviario($x = 0, $y = 0)
    {
        ...
        $aFont = $this->formatPadrao;
        $this->pTextBox($x, $y, $w * 0.23, $h, $texto, $aFont, 'T', 'L', 0, '');
        if ($this->infNF->item(0) !== null && $this->infNF->item(0)->getElementsByTagName('infUnidCarga')->item(0) !== null) {
            $texto = $this->infNF
                ->item(0)
            ...
            && $this->infOutros->item(0)->getElementsByTagName('infUnidCarga')->item(0) !== null
        ) {
